defmodule SeventhWardEqWeb.UserAuthTest do
  use SeventhWardEqWeb.ConnCase, async: true

  alias SeventhWardEq.Accounts
  alias SeventhWardEq.Accounts.Scope
  alias SeventhWardEqWeb.UserAuth

  import SeventhWardEq.AccountsFixtures

  @remember_me_cookie "_seventh_ward_eq_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SeventhWardEqWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
