defmodule SeventhWardEq.Accounts do
  @moduledoc """
  ...
  See `SeventhWardEq.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `SeventhWardEq.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  ## Examples
      ...
      iex> deliver_user_update_email_instructions(user, current_email, &url(~p"/admin/settings/confirm-email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
